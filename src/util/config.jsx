...
// Gởi đi (mở network để xem)
httpStore.interceptors.request.use((req)=>{
    req.headers = {
        ...req.headers,
        'Authorization': `${getDataTextStorage(TOKEN_AUTHOR)}`
    }
    return req;
},err=>{
...
/* 
    ...
    500: Error inserver (lỗi nầy có thể do frontend truyền giá trị không đúng format dẫn đến code server xử lý lỗi hoặc do front truyền đúng dữ liệu tuy nhiên backend trong quá trình xử lý logic code bị lỗi tại server)
*/
