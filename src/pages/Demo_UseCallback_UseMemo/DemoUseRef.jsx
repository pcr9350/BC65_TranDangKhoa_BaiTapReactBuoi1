...
const DemoUseRef = () => {
    ...
    // Dành cho các giá trị xử lý ngầm mà không cần đưa lên giao diện hiển thị
    // let count = 1;
    // useEffect(()=>{
  ...
  return (
    <div className='container'>
        ...
        <div ref={refDiv} className='p-2 bg-primary text-white'>
                ...
                UseRef:
                <br />
                <p>- UseRef giúp gán lại giá trị của component sau mỗi lần render
                    mà không phải load lại giao diện
                </p>
        ...
        <br />
        <input type="text" className='w-25 form-control d-inline' name='content' onChange={(e)=>{
            refContent.current = e.target.value;
        }}/>
        <button className='btn btn-success mr-2' onClick={handleSend}>send</button>
