  ...
  const handleChangeInput = async (e) => {
    ...
    if (value === "") {
      ...
      if (dataType === "email") {
        ...
        const regexTenTiengViet =
          /^[a-z A-ZÀÁÂÃÈÉÊÌÍÒÓÔÕÙÚĂĐĨŨƠàáâãèéêìíòóôõùúăđĩũơƯĂẠẢẤẦẨẪẬẮẰẲẴẶẸẺẼỀỀỂưăạảấầẩẫậắằẳẵặẹẻẽềềểễỄỆỈỊỌỎỐỒỔỖỘỚỜỞỠỢỤỦỨỪỬỮỰỲỴÝỶỸửữựỳỵỷỹ]{3,}$/u;
    ...
    <div className="container">
      <form className="w-50 mx-auto">
        ...
        <div className=" my-2 form-check">
          ...
          <div>
            <label htmlFor="Male" className="mx-2 form-check-label ">
              Male
            </label>
            <input
              type="radio"
              ...
              id="Male"
              value={"true"}
              checked={useRegister.gender === "true"}
              onChange={handleChangeInput}
            />
          </div>
          <div>
            <label className="mx-2 form-check-label " htmlFor="Female">
              Female
            </label>
            <input
              type="radio"
              ...
              id="Female"
              value={"false"}
              checked={useRegister.gender === "false"}
              onChange={handleChangeInput}
            />
          </div>
        </div>
